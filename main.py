...
# 6. Mask: True = keep (predicted), False = drop (known from input)
predicted_weights_dict, predicted_weights_list =instance_converter.apply_mask_to_weights(LG_nodes, LG_weights, S1)
